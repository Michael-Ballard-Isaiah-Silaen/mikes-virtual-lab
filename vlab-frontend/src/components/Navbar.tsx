    ...
    >
      ...
      <div className="flex gap-4">
        <nav className="hidden items-center justify-center gap-8 md:flex">
          <NavHashLink to="/#home" smooth className="hover:text-green-600">
            Home
          </NavHashLink>
          <NavHashLink
            to="/#features"
          ...
          <button className="group relative flex h-fit items-center gap-1">
            ...
            <div className="absolute bottom-0 right-0 h-0 translate-y-[100%] p-2 pt-4 opacity-0 group-hover:h-fit group-hover:opacity-100">
              <div className="hidden flex-col items-stretch rounded-lg border-[1px] bg-white p-2 text-start shadow-md group-hover:flex">
                <NavLink
                  to="/physics"
                  className="text-nowrap p-2 hover:text-green-500"
                >
                  Physics Lab
                </NavLink>
              </div>
        ...
        {currentUserContext?.currentUser?.username ? (
          <div className="group relative rounded-full border-2 border-[#00bf33] px-6 py-1 hover:bg-[#bdffce]">
          ...
          <div className="flex gap-4">
            ...
            <NavLink
              to="/auth/sign-in"
              className={`rounded-md bg-[#00bf33] px-6 text-white duration-100 ease-in hover:bg-green-800 ${className.buttonScrolled}`}
            >
              <p>Sign In</p>
            </NavLink>
          </div>
